    ...
    Component {
        ...
        ObjectModel {
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "Place the Asset Deck face down on the side of the gaming area. "
                ...
                RulebookText {
                    text: qsTr(
                              "NOTE: To add a bit more of unpredictability to the game, keep "
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "Command and Building Cards grant you Points via their Main Ability.")
                    Layout.fillWidth: true
                }
                ...
                RulebookText {
                    text: qsTr("A Troop Card adds its Defence to the Defence Value of the City where it is placed.")
                    Layout.fillWidth: true
                }
            }
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr("This is indicated by the following icon:")
                    Layout.fillWidth: true
                }
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr("The slot for Troop Cards is on the bottom left, the slot for Building "
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "Each player’s turn has 3 Phases. When these 3 Phases are completed,"
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr("Draw five cards from your House Deck.")
                    wrapMode: Text.WordWrap
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr("- Use Battle Points to Attack a City")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("-Use Knowledge Points to Seal/Unseal a Wonder Card")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("- Use Knowledge Points to Move Volfyirion")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("*Acquired cards are always put on top of your Discard Pile.")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("As special action, once per game, one of the players may be able to:")
                    wrapMode: Text.WordWrap
                    Layout.fillWidth: true
                    Layout.bottomMargin: 15
                }
                ...
                RulebookText {
                    text: qsTr("- Use Battle Points to Defeat Volfyirion")
                    wrapMode: Text.WordWrap
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr("When performing this action, Building and Troop Cards must be assigned"
                ...
                RulebookText {
                    text: qsTr("You can Gain Points from a card ability only once per turn.")
                    wrapMode: Text.WordWrap
                ...
                Pane {
                    ...
                    ColumnLayout {
                        ...
                        RulebookText {
                            text: qsTr(" 1. Play a card that triggers a Building’s Secondary Ability.")
                            wrapMode: Text.WordWrap
                        ...
                        RulebookText {
                            text: qsTr("2. Gain all bonuses (from both cards).")
                            wrapMode: Text.WordWrap
                        ...
                        RulebookText {
                            text: qsTr("3. Put In-Play a new Building (removing the old one from the game while doing so).")
                            wrapMode: Text.WordWrap
                            Layout.fillWidth: true
                        }

                        RulebookText {
                            text: qsTr(" 4. Gain all bonuses from the new Building.")
                            wrapMode: Text.WordWrap
                ...
                Pane {
                    ...
                    ColumnLayout {
                        ...
                        RulebookText {
                            text: qsTr("- 3 Battle Points - 3 from Flawless Deploy.")
                            wrapMode: Text.WordWrap
                            topPadding: 0
                            bottomPadding: 0
                        ...
                        RulebookText {
                            text: qsTr("- 6 Knowledge Points - 3 from Diviner, 1 from Apothecary, 2 from Flawless Deploy.")
                            wrapMode: Text.WordWrap
                            topPadding: 0
                            bottomPadding: 0
                        ...
                        RulebookText {
                            text: qsTr("No Secondary Abilities’ Synergy Chains are triggered.")
                            wrapMode: Text.WordWrap
                ...
                RulebookText {
                    ...
                    text: qsTr("ACQUIRE AN ASSET CARD")
                    wrapMode: Text.WordWrap
                    font.capitalization: Font.AllUppercase
                    font.bold: true
                ...
                Pane {
                    ...
                    ColumnLayout {
                        ...
                        RulebookText {
                            text: qsTr("NOTE: Only during their first turn and before acquiring any card:")
                            wrapMode: Text.WordWrap
                ...
                RulebookText {
                    ...
                    text: qsTr("REDEPLOY A TROOP CARD")
                    wrapMode: Text.WordWrap
                    font.capitalization: Font.AllUppercase
                    font.bold: true
                ...
                RulebookText {
                    text: qsTr("You may pay the cost of an In-Play Troop Card to reassign it"
                ...
                Pane {
                    ...
                    ColumnLayout {
                        ...
                        RulebookText {
                            text: qsTr("For 2 Battle Points, they Acquire Sharp Qoam [E].")
                            wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("You may pay 16 Battle Points to Defeat Volfyirion.")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("You may only Unseal cards that are sealed. Rotate them back to vertical "
                ...
                Pane {
                    ...
                    ColumnLayout {
                        ...
                        RulebookText {
                            text: qsTr("Unsealed Wonder (right).")
                            wrapMode: Text.WordWrap
                            horizontalAlignment: Text.AlignHCenter
                            topPadding: 0
                ...
                RulebookText {
                    ...
                    text: qsTr("REPLACE A CARD IN THE ASSET ROW")
                    wrapMode: Text.WordWrap
                    font.capitalization: Font.AllUppercase
                    font.bold: true
                ...
                RulebookText {
                    text: qsTr("You may not fill an empty space of the Asset Row this way.")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("Tip: you should replace cards before Acquiring from the Asset Row.")
                    wrapMode: Text.WordWrap
                ...
                ColumnLayout {
                    ...
                    RulebookText {
                        text: qsTr("You may pay 8 Knowledge Points to Move the Volfyirion Token.")
                        wrapMode: Text.WordWrap
                        bottomPadding: 0
                    ...
                    RulebookText {
                        text: qsTr("The dragon can only perform two kinds of movements:")
                        wrapMode: Text.WordWrap
                        topPadding: 0
                    ...
                    RulebookText {
                        text: qsTr("- From the Volfyirion’s Lair Card over an enemy City.")
                        wrapMode: Text.WordWrap
                        bottomPadding: 0
                    ...
                    RulebookText {
                        text: qsTr(" If you have enough points, you may perform both movements in the same turn.")
                        wrapMode: Text.WordWrap
                    ...
                    RulebookText {
                        text: qsTr("(See the “End of a Turn Phase” paragraph for more details.)")
                        wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("During each turn, a card’s Secondary Ability can only be triggered once.")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("1. The Synergy Chain Abilities")
                    wrapMode: Text.WordWrap
                    font.bold: true
                ...
                RulebookText {
                    text: qsTr("If the requirements are met, you Gain all the depicted bonuses.")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("NOTE: A card’s color does not count for its own Synergy Chain.")
                    wrapMode: Text.WordWrap
                    topPadding: 15
                    bottomPadding: 15
                    leftPadding: 17
                ...
                RulebookText {
                    text: qsTr("NOTE: You may decide to only partially gain the depicted bonus or to completely ignore"
                ...
                RulebookText {
                    text: qsTr(
                              "Choose any card from either your Playing Area, your Discard Pile, or your hand. The "
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr("When you are done performing actions, the End of a Turn Phase begins.")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("Follow the steps below in order.")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("- Except for Wonders, every card in the Playing Area is discarded onto the Discard Pile.")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("NOTE: Buildings and Troops are in the Cities Area.")
                    wrapMode: Text.WordWrap
                    topPadding: 15
                    bottomPadding: 15
                    leftPadding: 17
                ...
                RulebookText {
                    text: qsTr("- Discard all unplayed cards from your hand.")
                    wrapMode: Text.WordWrap
                    topPadding: 0
                    bottomPadding: 0
                ...
                RulebookText {
                    text: qsTr("- All unspent Points are lost")
                    wrapMode: Text.WordWrap
                    topPadding: 0
                    bottomPadding: 0
                ...
                RulebookText {
                    text: qsTr("- If the Volfyirion Token is on one of your opponent’s Cities, leave it there.")
                    wrapMode: Text.WordWrap
                    topPadding: 0
                    bottomPadding: 0
                ...
                RulebookText {
                    text: qsTr("- Refill all the empty spaces in the Asset Row and on Volfyirion’s Lair Card with new "
            ...
            ColumnLayout {
                ...
                Pane {
                    ...
                    contentItem: ColumnLayout {
                        ...
                        RulebookText {
                            text: qsTr(
                                      "Just like a standard Troop, a Mercenary Card adds "
                        ...
                        RulebookText {
                            text: qsTr(
                                      "If a legit Attack a City action is performed against a City "
                ...
                Pane {
                    ...
                    contentItem: ColumnLayout {
                        ...
                        RulebookText {
                            text: qsTr(
                                      "Perk Cards are meant to provide an asymmetrical experience.")
                            wrapMode: Text.WordWrap
                        ...
                        RulebookText {
                            text: qsTr(
                                      "Once per turn you may Seal one of your Wonder Cards to immediately "
                ...
                Pane {
                    ...
                    contentItem: ColumnLayout {
                        ...
                        RulebookText {
                            text: qsTr(
                                      "Ploy Cards are meant to provide an asymmetrical experience.")
                            wrapMode: Text.WordWrap
                        ...
                        RulebookText {
                            text: qsTr(
                                      "During setup, shuffle them and randomly deal one to each "
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "Use the backside of the Volfyirion’s Lair Card when playing the 2vs2 "
                        ...
                        Label {
                            ...
                            MouseArea {
                                ...
                                onClicked: Qt.openUrlExternally(
                                               "https://mysthea.tabula.games/volfyirion/extra-rules")
                            }
                        }
                    }
                }
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "Assemble, shuffle and place both the Asset Deck and Wonder Deck face down."
                ...
                Pane {
                    ...
                    ColumnLayout {
                        ...
                        RulebookText {
                            text: qsTr("Please consider this image as a reference for setup.")
                            wrapMode: Text.WordWrap
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "At the beginning of each of your turns and whenever you "
                ...
                RulebookText {
                    text: qsTr(
                              "During a turn, whenever you need to shuffle back your Discard "
                ...
                Pane {
                    ...
                    ColumnLayout {
                        ...
                        RulebookText {
                            text: qsTr("Following the previous example:")
                            wrapMode: Text.WordWrap
                            bottomPadding: 0
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "If you manage to gather enough Battle Points to Attack Volfyirion you ward off the creature and get to "
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "If you want to increase or decrease the level of challenge, consider the table "
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "During setup, place a single Volfyirion Token away from the two Lair Cards. Put back "
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "Turns are not individual, teammates perform their turn altogether, and they can freely discuss"
                ...
                RulebookText {
                    text: qsTr(
                              "If you, as a team, pay Knowledge Points equal to a card’s cost on the enemy "
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "Before attempting a Coop game, we highly recommend the players "
                ...
                RulebookText {
                    text: qsTr(
                              "In Volfyirion Coop Mode, House Volarees and House Rorius join "
                ...
                RulebookText {
                    text: qsTr(
                              "Your goal is to either defeat or subjugate the dreadful dragon. "
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "Remove from the game every card that contains a “Move Volfyirion” Secondary "
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "When you are done performing actions, and Volfyirion’s Attack "
                ...
                RulebookText {
                    text: qsTr(
                              "You and your ally may freely discuss how to spend points "
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "Volfyirion’s attack value is determined by the combined cost of the "
                ...
                RulebookText {
                    text: qsTr(
                              "When a player’s last City standing is destroyed, they’re out of the "
                ...
                RulebookText {
                    text: qsTr(
                              "For each destroyed City, add +1 to Volfyirion’s final Attack Value.")
                    Layout.fillWidth: true
                }

                RulebookText {
                    text: qsTr(
                              "If the final value is not enough to trigger a valid attack by "
                ...
                RulebookText {
                    text: qsTr(
                              "4. Discard all Wonder Cards from the grid but the one with the "
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "- Spend Battle Points equal to an In-Play Wonder Card cost to discard "
                ...
                RulebookText {
                    text: qsTr(
                              "- Spend 8 Knowledge Points to Move Volfyirion of one City Card clockwise "
                ...
                RulebookText {
                    text: qsTr(
                              "- Together, players may spend a total of 30 Battle Points to Attack "
                ...
                RulebookText {
                    text: qsTr(
                              "- A player may single-handedly spend a total of 20 Battle Points to "
            ...
            ColumnLayout {
                ...
                RulebookText {
                    text: qsTr(
                              "If you want to increase or decrease the level of challenge, consider the chart "
                              + "below when resolving step 3) of Volfyirion’s attack.")
                    Layout.fillWidth: true
                    Layout.bottomMargin: 15
                }
            ...
            ColumnLayout {
                ...
                ModeLabel {
                    contentMargins: root.contentMargins
                    width: parent.width
                    playMode: qsTr("community rules")

                    Layout.fillWidth: true
                }
            }

            // element 70: The victory of Volfyirion's Worshipper
            ColumnLayout {
                id: _theVictoryOfVolfyirionsWorshipper
                width: root.width
                spacing: 0
                ...
                RulebookLabel {
                    ...
                    onLinkActivated: Qt.openUrlExternally(
                                         "https://boardgamegeek.com/thread/2086996/fallen-islands-mini-extension")
                ...
                RulebookText {
                    text: qsTr("1. Separate your Asset Deck into two piles A and B.")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("2. Add the Broken Talisman card on top of pile A and the other on top of pile B.")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("4. Place pile A on top of pile B to form the Asset Deck.")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("Broken Talisman cards are an addition to play the game as usual.")
                    wrapMode: Text.WordWrap
                ...
                RulebookText {
                    text: qsTr("The Broken Talisman cards cannot be acquired.")
                    horizontalAlignment: Text.AlignJustify
                    wrapMode: Text.WordWrap
            ...
            // element 71: Volfyirion Bait & Death Eraser
            ColumnLayout {
                id: _volfyirionBaitDeathEraser
                width: root.width
                spacing: 0
                ...
                RulebookLabel {
                    text: qsTr("By <b>Adrian Pillai</b>")
                    horizontalAlignment: Text.AlignHCenter
                    Layout.bottomMargin: 0
                }
                ...
                RulebookLabel {
                    ...
                    onLinkActivated: Qt.openUrlExternally(
                                         "https://boardgamegeek.com/thread/2095770/community-cards-volfyirion-bait-death-eraser")
                ...
                RulebookLabel {
                    text: qsTr(
                              "<b>Type:</b> Wonder card.<br>" + "<b>Cost:</b> 2 Battle Points.<br>"
                              + "<b>Secondary Effect:</b> Moves Volfyirion to one of your Cities.")
                    wrapMode: Text.WordWrap
