    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ToolButton {
                text: "search"
                onClicked: {
                    _search.search(searchString.text)
                }
            }
            ...
            ToolButton {
                text: "P"
                onClicked: _search.prev()
            }

            ToolButton {
                text: "N"
                onClicked: _search.next()
            }
        }
        ...
        Flickable {
            ...
            contentWidth: edit1.contentWidth
            contentHeight: edit1.contentHeight + edit2.contentHeight
            clip: true
